...
// Test for module AES_FSM in decryption mode. Generates waveforms, verilog code and fir file
object TestAES_DecryptionFSM extends App {
  def module = new AES_FSM(encrypt = false) // define calling module for convenience, encrypt = false => decryption
  val name = "AES_DecryptionFSM" // name of output files
  ...
  chisel3.iotesters.Driver.execute(
    ...
    () => module) { c => new TestBenchAES_DecryptionFSM(c)}
...
class TestBenchAES_DecryptionFSM(dut: AES_FSM) extends PeekPokeTester(dut) {
