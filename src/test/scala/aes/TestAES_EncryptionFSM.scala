...
// Test for module AES_FSM in encryption mode. Generates waveforms, verilog code and fir file
object TestAES_EncryptionFSM extends App {
  def module = new AES_FSM // define calling module for convenience, encrypt = true => encryption
  val name = "AES_EncryptionFSM" // name of output files
