...
// Test for module AES_Pipelined in encryption mode. Generates waveforms, verilog code and fir file
object TestAES_EncryptionPipelined extends App {
  def module = new AES_Pipelined // define calling module for convenience, encrypt = true => encryption
  val name = "AES_EncryptionPipelined" // name of output files
