...
// Test for module DES_FSM in encryption mode. Generates waveforms, verilog code and fir file
object TestDES_EncryptionFSM extends App {
  def module = new DES_FSM(encrypt = true) // define calling module for convenience, encrypt = true => encryption
  val name = "DES_EncryptionFSM" // name of output files
  ...
  chisel3.iotesters.Driver.execute(
    ...
    () => module) { c => new TestBenchDES_EncryptionFSM(c)}
...
class TestBenchDES_EncryptionFSM(dut: DES_FSM) extends PeekPokeTester(dut) {
