...
object TestDES_Pipelined extends App {
  def module = new DES_EncryptionPipelined
  ...
  chisel3.iotesters.Driver.execute(
    ...
    () => module) { c => new TestBenchDES_Pipelined(c)}
...
class TestBenchDES_Pipelined(dut: DES_EncryptionPipelined) extends PeekPokeTester(dut) {
  step(10)
